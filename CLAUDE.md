...
**Next action:** close D1 (drop `chainId`, keep typed data primary, fallback policy per F2), D2, D8 in `docs/DECISIONS.md`; record the S1 gate in `docs/PLAN.md`; Peter gets sBZZ onto the Sepolia node; then S2 starts.
